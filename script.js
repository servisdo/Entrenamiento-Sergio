...
// ===== Templates (todos los ejercicios) =====
function ex(name, target, sets=3){ const s=[]; for(let i=0;i<sets;i++) s.push({w:"",r:""}); return {name, target, sets:s}; }
function makeAnterior(){ return { type:"Cara anterior", done:false, notes:"", exercises:[
  ex("Press banca horizontal","3 x 8–12"),
  ex("Elevaciones frontales en polea baja","3 x 10–12"),
  ex("Extensión de rodilla","3 x 10"),
  ex("Curl bíceps polea baja","3 x 10–12"),
  ex("Crunch en polea alta","3 x 12")
]};}
function makePosterior(){ return { type:"Cara posterior", done:false, notes:"", exercises:[
  ex("Pull-down en polea alta","3 x 10–12"),
  ex("Face pull en polea media","3 x 10–12"),
...
function makeHIIT(){ return { type:"HIIT", done:false, notes:"Z2 en calentamiento, 45\"/20\" circuito, finisher ≤150ppm", exercises:[
